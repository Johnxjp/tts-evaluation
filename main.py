...
def show_generation_page():
    ...
    with st.expander("ℹ️ Instructions", expanded=True):
        st.markdown(
            ...
            0. Obtain your provider API keys and enter them into the toolbar to the left
            1. **Enter your text** in the text area above
            2. Add emotions with <tag>{emotion}</tag> at any point in the speech. Best at start
            3. Click the **Generate Speech** button
            4. Listen to the audio generated by each TTS provider
            """
        )
